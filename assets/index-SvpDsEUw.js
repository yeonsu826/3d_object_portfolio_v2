 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ug;function bv(){return ug||(ug=1,(function(s){function e(q,le){var ae=q.length;q.push(le);e:for(;0<ae;){var U=ae-1>>>1,ee=q[U];if(0<o(ee,le))q[U]=le,q[ae]=ee,ae=U;else break e}}function t(q){return q.length===0?null:q[0]}function i(q){if(q.length===0)return null;var le=q[0],ae=q.pop();if(ae!==le){q[0]=ae;e:for(var U=0,ee=q.length,Fe=ee>>>1;U<Fe;){var He=2*(U+1)-1,Ie=q[He],oe=He+1,ye=q[oe];if(0>o(Ie,ae))oe<ee&&0>o(ye,Ie)?(q[U]=ye,q[oe]=ae,U=oe):(q[U]=Ie,q[He]=ae,U=He);else if(oe<ee&&0>o(ye,ae))q[U]=ye,q[oe]=ae,U=oe;else break e}}return le}function o(q,le){var ae=q.sortIndex-le.sortIndex;return ae!==0?ae:q.id-le.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;s.unstable_now=function(){return a.now()}}else{var c=Date,d=c.now();s.unstable_now=function(){return c.now()-d}}var f=[],h=[],m=1,_=null,g=3,y=!1,M=!1,b=!1,v=typeof setTimeout=="function"?setTimeout:null,S=typeof clearTimeout=="function"?clearTimeout:null,R=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function N(q){for(var le=t(h);le!==null;){if(le.callback===null)i(h);else if(le.startTime<=q)i(h),le.sortIndex=le.expirationTime,e(f,le);else break;le=t(h)}}function P(q){if(b=!1,N(q),!M)if(t(f)!==null)M=!0,ie(B);else{var le=t(h);le!==null&&K(P,le.startTime-q)}}function B(q,le){M=!1,b&&(b=!1,S(w),w=-1),y=!0;var ae=g;try{for(N(le),_=t(f);_!==null&&(!(_.expirationTime>le)||q&&!F());){var U=_.callback;if(typeof U=="function"){_.callback=null,g=_.priorityLevel;var ee=U(_.expirationTime<=le);le=s.unstable_now(),typeof ee=="function"?_.callback=ee:_===t(f)&&i(f),N(le)}else i(f);_=t(f)}if(_!==null)var Fe=!0;else{var He=t(h);He!==null&&K(P,He.startTime-le),Fe=!1}return Fe}finally{_=null,g=ae,y=!1}}var L=!1,O=null,w=-1,D=5,Y=-1;function F(){return!(s.unstable_now()-Y<D)}function Z(){if(O!==null){var q=s.unstable_now();Y=q;var le=!0;try{le=O(!0,q)}finally{le?ce():(L=!1,O=null)}}else L=!1}var ce;if(typeof R=="function")ce=function(){R(Z)};else if(typeof MessageChannel<"u"){var de=new MessageChannel,W=de.port2;de.port1.onmessage=Z,ce=function(){W.postMessage(null)}}else ce=function(){v(Z,0)};function ie(q){O=q,L||(L=!0,ce())}function K(q,le){w=v(function(){q(s.unstable_now())},le)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(q){q.callback=null},s.unstable_continueExecution=function(){M||y||(M=!0,ie(B))},s.unstable_forceFrameRate=function(q){0>q||125<q?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<q?Math.floor(1e3/q):5},s.unstable_getCurrentPriorityLevel=function(){return g},s.unstable_getFirstCallbackNode=function(){return t(f)},s.unstable_next=function(q){switch(g){case 1:case 2:case 3:var le=3;break;default:le=g}var ae=g;g=le;try{return q()}finally{g=ae}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(q,le){switch(q){case 1:case 2:case 3:case 4:case 5:break;default:q=3}var ae=g;g=q;try{return le()}finally{g=ae}},s.unstable_scheduleCallback=function(q,le,ae){var U=s.unstable_now();switch(typeof ae=="object"&&ae!==null?(ae=ae.delay,ae=typeof ae=="number"&&0<ae?U+ae:U):ae=U,q){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=ae+ee,q={id:m++,callback:le,priorityLevel:q,startTime:ae,expirationTime:ee,sortIndex:-1},ae>U?(q.sortIndex=ae,e(h,q),t(f)===null&&q===t(h)&&(b?(S(w),w=-1):b=!0,K(P,ae-U))):(q.sortIndex=ee,e(f,q),M||y||(M=!0,ie(B))),q},s.unstable_shouldYield=F,s.unstable_wrapCallback=function(q){var le=g;return function(){var ae=g;g=le;try{return q.apply(this,arguments)}finally{g=ae}}}})(Cd)),Cd}var dg;function Av(){return dg||(dg=1,Rd.exports=bv()),Rd.exports}/**
 * @license React
...
`)+`
`+S);const N=R+v+c,P=R+S+d,B=T_(o,o.VERTEX_SHADER,N),L=T_(o,o.FRAGMENT_SHADER,P);o.attachShader(b,B),o.attachShader(b,L),t.index0AttributeName!==void 0?o.bindAttribLocation(b,0,t.index0AttributeName):t.morphTargets===!0&&o.bindAttribLocation(b,0,"position"),o.linkProgram(b);function O(F){if(s.debug.checkShaderErrors){const Z=o.getProgramInfoLog(b)||"",ce=o.getShaderInfoLog(B)||"",de=o.getShaderInfoLog(L)||"",W=Z.trim(),ie=ce.trim(),K=de.trim();let q=!0,le=!0;if(o.getProgramParameter(b,o.LINK_STATUS)===!1)if(q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(o,b,B,L);else{const ae=b_(o,B,"vertex"),U=b_(o,L,"fragment");nt("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(b,o.VALIDATE_STATUS)+`
